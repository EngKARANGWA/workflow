    ...
    */
    ...
    'connections' => [
        ...
        'pgsql' => [
            'driver' => 'pgsql',
            'url' => env('DB_URL'),
            // Some providers (e.g. Neon) route connections by SNI, which older/bundled
            // libpq builds (notably on Windows) don't support. Appending the endpoint id
            // as a connection option keeps this working regardless of the client's libpq version.
            'host' => env('DB_HOST', '127.0.0.1').(env('DB_NEON_ENDPOINT') ? ";options=endpoint=".env('DB_NEON_ENDPOINT') : ''),
